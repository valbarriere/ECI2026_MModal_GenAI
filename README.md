...
|---|------|--------------|--------------|
| 1 | **Modelos de Visión** — GANs, modelos autoregresivos, autoencoders variacionales y modelos de difusión | [Generative_vision.pdf](https://users.dcc.uchile.cl/~vbarrier/ECI2026_MModal_GenAI/slides_es/Generative_vision.pdf) | [Lab1](Labs/Lab1/Lab1-Toonification.ipynb) — Edición de caras con GANs (StyleGAN toonification) |
| 2 | **Modelos de Lenguaje (LLM)** — modelización del lenguaje, tokenización, entropía y temperatura, In-Context Learning, instrucciones, alineamiento, entrenamiento y evaluación en la práctica | [Generative_LLMs.pdf](https://users.dcc.uchile.cl/~vbarrier/ECI2026_MModal_GenAI/slides_es/Generative_LLMs.pdf) | [Lab2](Labs/Lab2/Lab2-alignment_deployment.ipynb) — Instruction-tuning (SFT + LoRA) de Qwen2.5, base vs. SFT vs. Instruct |
| 3 | **Modelos de Audio** — procesamiento del audio, wav2vec/HuBERT/WavLM/AST, Speech-aware LLMs, tokenización y códecs, generación de música | [Audio_models.pdf](https://users.dcc.uchile.cl/~vbarrier/ECI2026_MModal_GenAI/slides_es/Audio_models.pdf) | [Lab3-1](Labs/Lab3/Lab3-1_AudioProcessing.ipynb) y [Lab3-2](Labs/Lab3/Lab3-2_AudioClassification.ipynb) — Preprocesamiento de audio y clasificación de género musical (GTZAN) con modelos preentrenados |
| 4 | **Modelos Multimodales** — tipos de fusión, CLIP, Stable Diffusion, modelos generativos (BLIP-1/2), modelos basados en LLM (Flamingo, LLaVA) | [Multimodal_LLM.pdf](https://users.dcc.uchile.cl/~vbarrier/ECI2026_MModal_GenAI/slides_es/Multimodal_LLM.pdf) | [Lab4](Labs/Lab4/Lab4.ipynb) — Clasificación multimodal de tweets de desastres (CrisisMMD) con fusión de texto e imagen |
| 5 | **LLM y LMM avanzados** — eficiencia, RAG, herramientas y agentes, Large Multimodal Models | [Advanced_llm.pdf](https://users.dcc.uchile.cl/~vbarrier/ECI2026_MModal_GenAI/slides_es/Advanced_llm.pdf) | [Lab5](Labs/Lab5/Lab5-lmm_final.ipynb) — Captioning y Visual Question Answering con SmolVLM y BLIP-2 |
...
* [1_Hugging_Face_Transformers_Tutorial](Tutoriales/1_Hugging_Face_Transformers_Tutorial.ipynb) — Introducción a la librería `transformers` de Hugging Face (pipelines, tokenizers, modelos preentrenados).
* [2_Multimodalidad](Tutoriales/2_Multimodalidad.ipynb) — Introducción a modelos y representaciones multimodales.
